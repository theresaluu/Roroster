...
describe RostersController do
  ...
  let(:valid_attributes) { { "overall" => "MyString" } }
  ...
  describe "PUT update" do
    describe "with valid params" do
      xit "updates the requested roster" do
        ...
        Roster.any_instance.should_receive(:update).with({ "overall" => "MyString" })
    ...
    describe "with invalid params" do
      xit "assigns the roster as @roster" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Roster.any_instance.stub(:save).and_return(false)
        put :update, {:id => roster.to_param, :roster => { "overall" => "invalid value" }}, valid_session
        assigns(:roster).should eq(roster)
      end
